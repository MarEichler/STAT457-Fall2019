...
func_EM <- function(start, max.iteration, mle, Y){
  theta_i <- start
...
start.1 <- func_EM(0.1, 100, mle1, Y1)
start.2 <- func_EM(0.2, 100, mle1, Y1)
start.3 <- func_EM(0.3, 100, mle1, Y1)
start.4 <- func_EM(0.4, 100, mle1, Y1)
start.6 <- func_EM(0.6, 100, mle1, Y1)
start.8 <- func_EM(0.8, 100, mle1, Y1)
...
start.1 <- func_EM(0.1, 100, mle2, Y2)
start.2 <- func_EM(0.2, 100, mle2, Y2)
start.3 <- func_EM(0.3, 100, mle2, Y2)
start.4 <- func_EM(0.4, 100, mle2, Y2)
start.6 <- func_EM(0.6, 100, mle2, Y2)
start.8 <- func_EM(0.8, 100, mle2, Y2)
