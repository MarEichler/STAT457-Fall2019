...
```{r func_pi,func_Metropolis,func_drivers}
...
func_driver2a1.Uniform <-    function(n){runif(n, min=0, max=1) }
func_driver2a2.Norm.sd.01 <- function(n){rnorm(n, mean=theta.i, sd=0.01)}
func_driver2a3.Norm.sd.1 <-  function(n){rnorm(n, mean=theta.i, sd=0.1)}
func_driver2a4.Norm.sd.5 <-  function(n){rnorm(n, mean=theta.i, sd=0.5)}
func_driver2a5.Norm.mu.4sd.5 <-  function(n){rnorm(n, mean=0.4, sd=0.5)}
```
...
func_problem2ABC(211, 10000, Y.A, func_driver2a1.Uniform, "Uniform(0,1)")
func_problem2ABC(212, 10000, Y.A, func_driver2a2.Norm.sd.01,   "Normal(theta.i, 0.01)")
func_problem2ABC(213, 10000, Y.A, func_driver2a3.Norm.sd.1,    "Normal(theta.i, 0.10)")
func_problem2ABC(214, 10000, Y.A, func_driver2a4.Norm.sd.5,    "Normal(theta.i, 0.50)")
func_problem2ABC(215, 10000, Y.A, func_driver2a5.Norm.mu.4sd.5,"Normal(0.40, 0.10)")
```
...
func_problem2ABC(221, 10000, Y.B, func_driver2a1.Uniform, "Uniform(0,1)")
func_problem2ABC(222, 10000, Y.B, func_driver2a2.Norm.sd.01,   "Normal(theta.i, 0.01)")
func_problem2ABC(223, 10000, Y.B, func_driver2a3.Norm.sd.1,    "Normal(theta.i, 0.10)")
func_problem2ABC(224, 10000, Y.B, func_driver2a4.Norm.sd.5,    "Normal(theta.i, 0.50)")
func_problem2ABC(225, 10000, Y.B, func_driver2a5.Norm.mu.4sd.5,"Normal(0.40, 0.10)")
```
